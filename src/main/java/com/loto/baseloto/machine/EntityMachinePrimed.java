package com.loto.baseloto.machine;
...
public class EntityMachinePrimed extends Entity
{
    /** How long the fuse is */
    public int fuse;
    private EntityLivingBase tntPlacedBy;

    public EntityMachinePrimed(World worldIn)
    {
        super(worldIn);
    ...
    public EntityMachinePrimed(World worldIn, double p_i1730_2_, double p_i1730_4_, double p_i1730_6_, EntityLivingBase p_i1730_8_)
    {
        this(worldIn);
    ...
    public void onUpdate()
    {
        ...
        this.move(null, this.motionX, this.motionY, this.motionZ);
